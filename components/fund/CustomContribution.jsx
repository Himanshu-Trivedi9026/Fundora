 ...
 */
export default function CustomContribution({
  value,
  onChange,
  selected,
  onSelect,
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center">
        ...
        <span className="text-xs text-on-surface-variant italic font-inter">
          No reward, just support
        </span>
      </div>

      <div className="relative">
        <span
          className="absolute left-4 top-1/2 -translate-y-1/2 text-on-surface-variant font-inter"
          aria-hidden="true"
        >
          ₹
        </span>
      ...
      {value && Number(value) > 0 && Number(value) < 10 && (
        <p className="text-danger text-xs font-inter" role="alert">
