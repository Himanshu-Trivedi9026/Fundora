  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <span className="absolute left-4 top-1/2 -translate-y-1/2 text-on-surface-variant font-inter" aria-hidden="true">
          ₹
        </span>
        <input
          type="number"
      ...
      {value && Number(value) > 0 && Number(value) < 10 && (
        <p className="text-danger text-xs font-inter" role="alert">Minimum amount is ₹10</p>
      )}
    </motion.div>
  );
}
