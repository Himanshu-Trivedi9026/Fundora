  ...
  return (
    ...
    >
      <motion.h3
        ...
        className="font-geist text-lg font-semibold text-on-surface mb-3"
      >
        About
      </motion.h3>
      ...
      <motion.p
        variants={staggerItem}
        className="text-on-surface-variant text-sm font-inter leading-relaxed mb-4"
      >
      ...
      {achievements.length > 0 && (
        <>
          ...
          <motion.h4
            variants={staggerItem}
            className="font-geist text-sm font-medium text-on-surface-variant mb-3"
          >
            Badges
          </motion.h4>
