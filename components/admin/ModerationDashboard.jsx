...
export default function ModerationDashboard() {
  ...
  async function handleResolve(e) {
    ...
    await handleCaseAction(selectedCase.id, "resolve", {
          ...
          {summary.actionDistribution && (
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
              ...
              <div className="space-y-2">
                {Object.entries(summary.actionDistribution).map(
                  ([action, count]) => (
                    <div
                      key={action}
                      ...
                      <div className="flex items-center gap-3">
                        <div className="w-32 bg-gray-800 rounded-full h-2">
                          <div
                            ...
                            style={{
                              width: `${summary.totalReports ? (count / summary.totalReports) * 100 : 0}%`,
                            }}
                          />
                        </div>
              ...
              <div className="divide-y divide-gray-800/50">
                {data.recentCases.map((c) => (
                  ...
                  >
                    ...
                    <span
                      className={`px-2 py-0.5 rounded-full text-xs ${severityColors[c.severity] || "bg-gray-800 text-gray-300"}`}
                    >
                      {c.severity || "—"}
                    </span>
                  </button>
              ...
              <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
                  ...
                  <div>
                    <div className="flex items-center gap-3">
                      <h3 className="text-white font-bold text-lg">
                        {selectedCase.report_type || selectedCase.type}
                      </h3>
                      <span
                      ...
                      {selectedCase.severity && (
                        <span
                          className={`px-3 py-1 rounded-full text-xs ${severityColors[selectedCase.severity] || "bg-gray-800 text-gray-300"}`}
                        >
                          {selectedCase.severity}
                        </span>
                      )}
                ...
                <div className="flex gap-4 text-xs text-gray-500 mb-4">
                  {selectedCase.reporter_id && (
                    <span>
                      Reporter: {selectedCase.reporter_id.substring(0, 8)}...
                    </span>
                  )}
                  {selectedCase.target_id && (
                    <span>
                      Target: {selectedCase.target_id.substring(0, 8)}...
                    </span>
                  )}
                </div>
                ...
                <div className="flex gap-2 mt-4 flex-wrap">
                  {selectedCase.status !== "resolved" && (
                    <>
                      <button
                        onClick={() =>
                          handleCaseAction(selectedCase.id, "assign_moderator")
                        }
              ...
              <div className="bg-gray-900 border border-gray-800 rounded-xl p-4">
                <div className="flex gap-3 flex-wrap">
                  ...
                  >
                    ...
                    <option value="misleading_content">
                      Misleading Content
                    </option>
                    <option value="fraudulent_campaign">
                      Fraudulent Campaign
                    </option>
