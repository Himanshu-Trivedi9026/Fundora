  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-4 md:px-16 py-12 md:py-16 overflow-hidden">
      ...
      >
        ...
        >
          <span className="material-symbols-outlined text-[18px] text-primary" aria-hidden="true">auto_awesome</span>
        ...
        <motion.h1 variants={fadeUp} className="font-geist text-5xl md:text-7xl font-bold mb-6 leading-tight">
          ...
          <span className="block bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent" aria-label={fullText}>
            {typed}
            <span className="border-r-2 border-primary animate-pulse ml-0.5" aria-hidden="true">&nbsp;</span>
          </span>
        </motion.h1>
        ...
        <div className="glass-card p-6 rounded-xl border border-white/[0.06] shadow-2xl">
          <div className="grid grid-cols-3 gap-6 text-center">
            <div className="space-y-1">
              ...
              <p className="font-geist text-lg font-bold text-on-surface">Launch</p>
              <p className="text-on-surface-variant font-inter text-xs">AI-powered project creation</p>
            </div>
            <div className="space-y-1">
              <span className="material-symbols-outlined text-primary text-2xl" aria-hidden="true">trending_up</span>
              <p className="font-geist text-lg font-bold text-on-surface">Fund</p>
              <p className="text-on-surface-variant font-inter text-xs">Intelligent crowdfunding</p>
            </div>
            <div className="space-y-1">
              <span className="material-symbols-outlined text-primary text-2xl" aria-hidden="true">insights</span>
              <p className="font-geist text-lg font-bold text-on-surface">Scale</p>
              <p className="text-on-surface-variant font-inter text-xs">Data-driven growth</p>
            </div>
          </div>
        </div>
      </motion.div>
