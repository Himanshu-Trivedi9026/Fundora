      ...
      <div className="max-w-6xl mx-auto px-4 md:px-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-on-surface-variant font-inter max-w-xl mx-auto">
            Venture capital is no longer a guessing game. Our platform
            orchestrates the entire journey from due diligence to exit.
          </p>
        </div>
        ...
        >
          ...
          >
            ...
            <h4 className="font-geist text-xl font-semibold text-on-surface mb-2">
              01. AI Due Diligence
            </h4>
            <p className="text-on-surface-variant font-inter mb-4">
              Our proprietary algorithms analyze 5,000+ data points including
              founder history, market velocity, and sentiment trends.
            </p>
            <div className="flex flex-wrap gap-2">
              {["Sentiment Analysis", "Velocity Score", "Founder DNA"].map(
                (pill) => (
                  <span
                    key={pill}
                    className="bg-surface-container px-3 py-1 rounded text-xs font-inter border border-white/[0.06] text-on-surface-variant"
                  >
                    {pill}
                  </span>
                ),
          ...
          >
            <div>
              ...
              <h4 className="font-geist text-xl font-semibold mb-2">
                02. Secure Escrow
              </h4>
              <p className="opacity-80 font-inter text-sm">
                All capital is managed via smart-contract escrows, ensuring 100%
                transparency and goal-based fund release.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="hidden sm:block shrink-0">
              <div className="w-32 h-32 rounded-xl bg-surface-container flex items-center justify-center overflow-hidden">
                <span
                  className="material-symbols-outlined text-4xl text-primary/30"
                  aria-hidden="true"
                >
                  memory
                </span>
            ...
            <div>
              <h4 className="font-geist text-xl font-semibold text-on-surface mb-2">
                04. Growth Intelligence
              </h4>
              <p className="text-on-surface-variant font-inter">
                Post-funding, startups receive AI-driven strategic guidance to
                scale operations and optimize customer acquisition costs.
              </p>
            </div>
          </motion.div>
        </motion.div>
