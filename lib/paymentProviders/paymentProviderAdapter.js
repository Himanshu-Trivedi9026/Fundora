...
class BasePaymentProvider {
  ...
  async createPayout(params) { throw new Error("Not implemented"); }
  async checkStatus(transactionId) { throw new Error("Not implemented"); }
  async cancelPayout(transactionId) { throw new Error("Not implemented"); }
  async getBalance() { throw new Error("Not implemented"); }
  async validateAccount(accountDetails) { throw new Error("Not implemented"); }
  async healthCheck() { throw new Error("Not implemented"); }
  get name() { return this.constructor.name; }
  get supportedCurrencies() { return []; }
  get supportedCountries() { return []; }
}
...
class MockPaymentProvider extends BasePaymentProvider {
  ...
  get supportedCurrencies() { return ["INR", "USD", "EUR", "GBP", "CAD", "AUD", "SGD", "AED", "CHF"]; }
  get supportedCountries() { return ["IN", "US", "GB", "DE", "FR", "CA", "AU", "SG", "AE", "CH"]; }
...
class StripePaymentProvider extends BasePaymentProvider {
  ...
  async checkStatus(transactionId) {
    return { success: true, data: { transactionId, status: "completed", provider: "stripe" } };
  }
  ...
  async getBalance() {
    return { success: true, data: { available: 5000000, currency: "USD", pending: 200000 } };
  }
  ...
  get supportedCurrencies() { return ["USD", "EUR", "GBP", "CAD", "AUD", "CHF", "SGD"]; }
  get supportedCountries() { return ["US", "GB", "DE", "FR", "CA", "AU", "SG", "CH", "IE", "NL"]; }
}
...
class PayPalPaymentProvider extends BasePaymentProvider {
  ...
  async checkStatus(transactionId) {
    return { success: true, data: { transactionId, status: "completed", provider: "paypal" } };
  }
  ...
  async validateAccount(accountDetails) {
    return { success: true, data: { valid: true, email: accountDetails.email } };
  }
  ...
  get supportedCurrencies() { return ["USD", "EUR", "GBP", "CAD", "AUD", "JPY"]; }
  get supportedCountries() { return ["US", "GB", "DE", "FR", "IT", "ES", "CA", "AU"]; }
}
...
class WisePaymentProvider extends BasePaymentProvider {
  ...
  async checkStatus(transactionId) {
    return { success: true, data: { transactionId, status: "completed", provider: "wise" } };
  }
  ...
  async getBalance() {
    return { success: true, data: { available: 2000000, currency: "USD", balances: { USD: 1000000, EUR: 800000, GBP: 200000 } } };
  }

  async validateAccount(accountDetails) {
    return { success: true, data: { valid: true, currency: accountDetails.currency } };
  }
  ...
  get supportedCurrencies() { return ["USD", "EUR", "GBP", "INR", "CAD", "AUD", "CHF", "SGD", "AED", "JPY"]; }
  get supportedCountries() { return ["IN", "US", "GB", "DE", "FR", "CA", "AU", "SG", "AE", "CH", "JP"]; }
}
...
class AdyenPaymentProvider extends BasePaymentProvider {
  ...
  async checkStatus(transactionId) {
    return { success: true, data: { transactionId, status: "completed", provider: "adyen" } };
  }

  async cancelPayout() { return { success: true, data: { status: "cancelled" } }; }
  async getBalance() { return { success: true, data: { available: 8000000, currency: "EUR" } }; }
  async validateAccount() { return { success: true, data: { valid: true } }; }
  async healthCheck() { return { success: true, data: { healthy: true, latencyMs: 100 } }; }
  get name() { return "Adyen"; }
  get supportedCurrencies() { return ["USD", "EUR", "GBP", "CAD", "AUD", "CHF", "SGD", "AED", "JPY"]; }
  get supportedCountries() { return ["US", "GB", "DE", "FR", "NL", "ES", "IT", "CA", "AU", "AE", "JP", "SG"]; }
}
...
class RazorpayPayoutProvider extends BasePaymentProvider {
  ...
  async checkStatus(transactionId) {
    return { success: true, data: { transactionId, status: "completed", provider: "razorpay" } };
  }

  async cancelPayout() { return { success: true, data: { status: "cancelled" } }; }
  async getBalance() { return { success: true, data: { available: 10000000, currency: "INR" } }; }
  async validateAccount(accountDetails) {
    return { success: true, data: { valid: true, bankName: "Mock Bank" } };
  }
  async healthCheck() { return { success: true, data: { healthy: true, latencyMs: 80 } }; }
  get name() { return "Razorpay"; }
  get supportedCurrencies() { return ["INR"]; }
  get supportedCountries() { return ["IN"]; }
}
...
class CashfreePaymentProvider extends BasePaymentProvider {
  ...
  async checkStatus(transactionId) {
    return { success: true, data: { transactionId, status: "completed", provider: "cashfree" } };
  }

  async cancelPayout() { return { success: true, data: { status: "cancelled" } }; }
  async getBalance() { return { success: true, data: { available: 5000000, currency: "INR" } }; }
  async validateAccount() { return { success: true, data: { valid: true } }; }
  async healthCheck() { return { success: true, data: { healthy: true, latencyMs: 60 } }; }
...
export function registerPaymentProvider(name, provider) {
  ...
  return { success: true, data: { name, supportedCurrencies: provider.supportedCurrencies } };
}
...
export function initializePaymentProviders() {
  ...
  return { success: true, data: { count: providers.length, active: _activeProvider } };
}

export { BasePaymentProvider, MockPaymentProvider, StripePaymentProvider, PayPalPaymentProvider, WisePaymentProvider, AdyenPaymentProvider, RazorpayPayoutProvider, CashfreePaymentProvider };
