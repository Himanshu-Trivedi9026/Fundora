...
export async function createOrganization({
  ...
  try {
    ...
    if (!ORG_TYPES.includes(type)) {
      return { success: false, error: `Invalid type: ${type}. Must be one of: ${ORG_TYPES.join(", ")}` };
    }
    ...
    if (orgErr) {
      logError("Organization", "createOrganization insert error", { error: orgErr.message });
    ...
    if (memberErr) {
      logError("Organization", "createOrganization add owner error", { error: memberErr.message });
    ...
    logInfo("Organization", "Organization created", { orgId: org.id, name, ownerId });

    return { success: true, data: org };
  } catch (err) {
    logError("Organization", "createOrganization unexpected error", { error: err.message });
...
export async function getOrganization(orgId) {
  try {
    ...
    if (error) {
      logError("Organization", "getOrganization query error", { error: error.message });
      return { success: false, error: error.message };
    }

    return { success: true, data };
  } catch (err) {
    logError("Organization", "getOrganization unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
...
export async function getOrganizationBySlug(slug) {
  try {
    ...
    logError("Organization", "getOrganizationBySlug unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
...
export async function updateOrganization(orgId, updates, userId) {
  try {
    if (!orgId || !updates || !userId) {
      return { success: false, error: "orgId, updates, and userId are required" };
    }
    ...
    const allowedFields = [
      "name", "description", "website", "logo_url", "type", "industry", "size",
      "tax_id", "registration_number", "contact_email", "contact_phone",
      "address", "settings", "metadata", "status",
    ];
    ...
    if (error) {
      logError("Organization", "updateOrganization error", { error: error.message });
      return { success: false, error: error.message };
    }
    ...
    logError("Organization", "updateOrganization unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
...
export async function deleteOrganization(orgId, userId) {
  try {
    ...
    if (!member || member.role !== "owner") {
      return { success: false, error: "Only the organization owner can delete" };
    }
    ...
    if (error) {
      logError("Organization", "deleteOrganization error", { error: error.message });
      return { success: false, error: error.message };
    }
    ...
    logError("Organization", "deleteOrganization unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
 ...
 */
export async function listOrganizations({ userId, type, status, limit = 50, offset = 0 } = {}) {
  try {
    ...
    if (error) {
      logError("Organization", "listOrganizations error", { error: error.message });
      return { success: false, error: error.message };
    }

    return { success: true, data: data || [], total: count || 0 };
  } catch (err) {
    logError("Organization", "listOrganizations unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
...
export async function getUserOrganizations(userId) {
  try {
    ...
    if (memErr) {
      logError("Organization", "getUserOrganizations memberships error", { error: memErr.message });
    ...
    if (orgErr) {
      logError("Organization", "getUserOrganizations orgs error", { error: orgErr.message });
      return { success: false, error: orgErr.message };
    }
    ...
    const result = (orgs || []).map((org) => {
      ...
      return { ...org, membership_role: membership?.role, membership_joined_at: membership?.joined_at };
    });

    return { success: true, data: result };
  } catch (err) {
    logError("Organization", "getUserOrganizations unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
...
export async function transferOwnership(orgId, currentOwnerId, newOwnerId) {
  try {
    if (!orgId || !currentOwnerId || !newOwnerId) {
      return { success: false, error: "orgId, currentOwnerId, and newOwnerId are required" };
    }
    ...
    if (orgErr) {
      logError("Organization", "transferOwnership org update error", { error: orgErr.message });
      return { success: false, error: orgErr.message };
    }
    ...
    logInfo("Organization", "Ownership transferred", { orgId, from: currentOwnerId, to: newOwnerId });

    return { success: true, data: { orgId, newOwnerId } };
  } catch (err) {
    logError("Organization", "transferOwnership unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
...
export async function archiveOrganization(orgId, userId) {
  try {
    ...
    logError("Organization", "archiveOrganization unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
 ...
 */
export async function addMember({ organizationId, userId, role = "member", invitedBy }) {
  try {
    if (!organizationId || !userId) {
      return { success: false, error: "organizationId and userId are required" };
    }
    ...
    if (error) {
      logError("Organization", "addMember insert error", { error: error.message });
      return { success: false, error: error.message };
    }
    ...
    logError("Organization", "addMember unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
...
export async function removeMember(organizationId, userId, performedBy) {
  try {
    if (!organizationId || !userId || !performedBy) {
      return { success: false, error: "organizationId, userId, and performedBy are required" };
    }
    ...
    logError("Organization", "removeMember unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
 ...
 */
export async function updateMemberRole(organizationId, userId, newRole, performedBy) {
  try {
    ...
    if (target?.role === "owner") {
      return {
        success: false,
        error: "The organization owner's role can only be changed via ownership transfer",
      };
    }
    ...
    logError("Organization", "updateMemberRole unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
 ...
 */
export async function getMembers(organizationId, { role, status = "active", limit = 50, offset = 0 } = {}, performedBy) {
  try {
    if (!organizationId) {
    ...
    logError("Organization", "getMembers unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
...
export async function getMember(organizationId, userId, performedBy) {
  try {
    ...
    logError("Organization", "getMember unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
 ...
 */
export async function createInvitation({ organizationId, email, role = "member", invitedBy }) {
  try {
    if (!organizationId || !email || !invitedBy) {
      return { success: false, error: "organizationId, email, and invitedBy are required" };
    }
    ...
    if (error) {
      logError("Organization", "createInvitation insert error", { error: error.message });
      return { success: false, error: error.message };
    }
    ...
    logError("Organization", "createInvitation unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
...
export async function acceptInvitation(invitationId, userId, userEmail) {
  try {
    ...
    if (invite.status !== "pending") {
      return { success: false, error: `Invitation is ${invite.status}, not pending` };
    }
    ...
    if (userEmail && invite.email && userEmail.toLowerCase() !== invite.email.toLowerCase()) {
      return { success: false, error: "This invitation is not addressed to you" };
    }
    ...
    logError("Organization", "acceptInvitation unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
...
export async function revokeInvitation(invitationId, performedBy) {
  try {
    if (!invitationId || !performedBy) {
      return { success: false, error: "invitationId and performedBy are required" };
    }
    ...
    logError("Organization", "revokeInvitation unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
 ...
 */
export async function getInvitations(organizationId, { status, limit = 50, offset = 0 } = {}, performedBy) {
  try {
    if (!organizationId) {
      return { success: false, error: "organizationId is required" };
    }
    ...
    if (performedBy) {
      const permitted = await canManageRole(organizationId, performedBy, "member");
      if (!permitted.allowed) {
        return { success: false, error: permitted.error };
      }
    }
    ...
    logError("Organization", "getInvitations unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
 ...
 * Create a department.
 */
export async function createDepartment({ organizationId, name, parentDepartmentId, headUserId, description }) {
  try {
    ...
    if (error) {
      logError("Organization", "createDepartment error", { error: error.message });
      return { success: false, error: error.message };
    }

    return { success: true, data };
  } catch (err) {
    logError("Organization", "createDepartment unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
...
export async function updateDepartment(departmentId, updates, performedBy) {
  try {
    if (!departmentId || !updates || !performedBy) {
      return { success: false, error: "departmentId, updates, and performedBy are required" };
    }

    const allowedFields = ["name", "description", "parent_department_id", "head_user_id", "budget", "status", "metadata"];
    const sanitized = {};
    for (const [key, value] of Object.entries(updates)) {
      if (allowedFields.includes(key)) {
        sanitized[key] = value;
    ...
    logError("Organization", "updateDepartment unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
...
export async function deleteDepartment(departmentId, performedBy) {
  try {
    if (!departmentId || !performedBy) {
      return { success: false, error: "departmentId and performedBy are required" };
    }
    ...
    logError("Organization", "deleteDepartment unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
...
export async function getDepartments(organizationId) {
  try {
    ...
    logError("Organization", "getDepartments unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
 ...
 * Create a team.
 */
export async function createTeam({ organizationId, departmentId, name, teamLeadId, description }) {
  try {
    if (!organizationId || !name) {
      return { success: false, error: "organizationId and name are required" };
    }
    ...
    logError("Organization", "createTeam unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
...
export async function addTeamMember(teamId, userId, role = "member") {
  try {
    ...
    logError("Organization", "addTeamMember unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
...
export async function removeTeamMember(teamId, userId) {
  try {
    ...
    logError("Organization", "removeTeamMember unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
...
export async function getTeams(organizationId, { departmentId } = {}) {
  try {
    ...
    logError("Organization", "getTeams unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
...
export async function getOrganizationSettings(organizationId, performedBy) {
  try {
    ...
    logError("Organization", "getOrganizationSettings unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
 ...
 */
export async function setOrganizationSetting(organizationId, key, value, performedBy) {
  try {
    ...
    if (error) {
      logError("Organization", "setOrganizationSetting upsert error", { error: error.message });
      return { success: false, error: error.message };
    }
    ...
    logError("Organization", "setOrganizationSetting unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
...
export async function getOrganizationSetting(organizationId, key, performedBy) {
  try {
    ...
    logError("Organization", "getOrganizationSetting unexpected error", { error: err.message });
    return { success: false, error: "Internal error" };
  }
}
