...
class LoginFrequencySignal extends SignalProvider {
  ...
  async collect(userId) {
    try {
      ...
      return { value: { count: 0, isNormal: false, isSuspicious: false }, confidence: 0, metadata: {} };
    }
  }
}
...
class DonationVelocitySignal extends SignalProvider {
  ...
  async collect(userId) {
    try {
      ...
      return { value: { count: 0, isSuspicious: false }, confidence: 0, metadata: {} };
    }
  }
}
...
class DeviceFingerprintSignal extends SignalProvider {
  ...
  async collect(userId) {
    try {
      ...
      return { value: { count: 0, hasKnownDevice: true, newDevice: false, riskFlags: [] }, confidence: 0, metadata: {} };
    }
  }
}
...
class TrustScoreSignal extends SignalProvider {
  ...
  async collect(userId) {
    try {
      ...
      return { value: { trustScore: 0, verificationLevel: 0 }, confidence: 0, metadata: {} };
    }
  }
}
...
class FraudHistorySignal extends SignalProvider {
  ...
  async collect(userId) {
    try {
      ...
      return { value: { ruleHitCount: 0, lastRiskScore: 0, lastDecision: "allow" }, confidence: 0, metadata: {} };
    }
  }
}
...
class AccountAgeSignal extends SignalProvider {
  ...
  async collect(userId) {
    try {
      ...
      return { value: { accountAgeDays: 0, isNew: true, isEstablished: false }, confidence: 0, metadata: {} };
    }
  }
}
...
export function getProvidersByCategory(category) {
  return Array.from(signalProviders.values()).filter((p) => p.category === category);
}
