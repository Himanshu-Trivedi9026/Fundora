...
export async function notifyVerificationSubmitted({
  ...
  return {
    success: true,
    channel: "console",
    event: NOTIFICATION_EVENTS.SUBMITTED,
  };
}
...
export async function notifyVerificationApproved({
  ...
  return {
    success: true,
    channel: "console",
    event: NOTIFICATION_EVENTS.APPROVED,
  };
}
...
export async function notifyVerificationRejected({ email, fullName, reason }) {
  ...
  return {
    success: true,
    channel: "console",
    event: NOTIFICATION_EVENTS.REJECTED,
  };
}
...
export async function notifyVerificationExpired({ email, fullName }) {
  ...
  return {
    success: true,
    channel: "console",
    event: NOTIFICATION_EVENTS.EXPIRED,
  };
}
 ...
 */
export async function notifyVerificationExpiringSoon({
  email,
  fullName,
  daysUntilExpiry,
}) {
  ...
  return {
    success: true,
    channel: "console",
    event: NOTIFICATION_EVENTS.EXPIRING_SOON,
  };
}
 ...
 */
export async function notifyVerificationLevelChanged({
  email,
  fullName,
  oldLevel,
  newLevel,
  ...
  return {
    success: true,
    channel: "console",
    event: NOTIFICATION_EVENTS.LEVEL_CHANGED,
  };
}
...
export async function notifyDocumentUploaded({
  ...
  return {
    success: true,
    channel: "console",
    event: NOTIFICATION_EVENTS.DOCUMENT_UPLOADED,
  };
}
...
export async function notifyDocumentVerified({
  ...
  return {
    success: true,
    channel: "console",
    event: NOTIFICATION_EVENTS.DOCUMENT_VERIFIED,
  };
}
...
export async function notifyOTPSent({ email, phone }) {
  ...
  return {
    success: true,
    channel: "console",
    event: NOTIFICATION_EVENTS.OTP_SENT,
  };
}
...
export async function notifyOTPVerified({ email, phone }) {
  ...
  return {
    success: true,
    channel: "console",
    event: NOTIFICATION_EVENTS.OTP_VERIFIED,
  };
}
...
export async function notifyOTPFailed({ email, phone, attemptsRemaining }) {
  ...
  return {
    success: true,
    channel: "console",
    event: NOTIFICATION_EVENTS.OTP_FAILED,
  };
}
 ...
 */
export async function notifyManualReviewAssigned({
  email,
  fullName,
  priority,
}) {
  ...
  return {
    success: true,
    channel: "console",
    event: NOTIFICATION_EVENTS.MANUAL_REVIEW_ASSIGNED,
  };
}
 ...
 */
export async function notifyManualReviewCompleted({
  email,
  fullName,
  decision,
}) {
  ...
  return {
    success: true,
    channel: "console",
    event: NOTIFICATION_EVENTS.MANUAL_REVIEW_COMPLETED,
  };
}
...
export async function notifySelfieCaptured({ email }) {
  ...
  return {
    success: true,
    channel: "console",
    event: NOTIFICATION_EVENTS.SELFIE_CAPTURED,
  };
}
...
export async function notifySelfieValidationPassed({ email }) {
  ...
  return {
    success: true,
    channel: "console",
    event: NOTIFICATION_EVENTS.SELFIE_VALIDATION_PASSED,
  };
}
...
export async function notifySelfieValidationFailed({ email, reason }) {
  ...
  return {
    success: true,
    channel: "console",
    event: NOTIFICATION_EVENTS.SELFIE_VALIDATION_FAILED,
  };
}
