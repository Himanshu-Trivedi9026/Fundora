...
export class BusinessVerificationProvider extends BaseVerificationProvider {
  ...
  async initialize() {
    logInfo("BusinessVerificationProvider", "Mock business verification provider initialized");
  }
  ...
  async submitVerification(businessData) {
    ...
    logInfo("BusinessVerificationProvider", "Business verification submitted (mock)", {
      referenceId,
  ...
  async cancel(referenceId) {
    logInfo("BusinessVerificationProvider", "Business verification cancelled (mock)", { referenceId });
    return { success: true };
  }
