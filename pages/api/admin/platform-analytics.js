    ...
    if (req.method === "GET") {
      ...
      try {
        ...
        if (mode === "health" || !mode) {
          ...
          return res
            .status(200)
            .json({ success: true, data: health.success ? health.data : {} });
        }
        ...
        if (mode === "trust") {
          ...
          return res
            .status(200)
            .json({ success: true, data: trust.success ? trust.data : {} });
        }
        ...
        if (mode === "fraud") {
          ...
          return res
            .status(200)
            .json({ success: true, data: fraud.success ? fraud.data : {} });
        }
        ...
        if (mode === "escrow") {
          ...
          return res
            .status(200)
            .json({ success: true, data: escrow.success ? escrow.data : {} });
        }
        ...
        if (mode === "milestones") {
          ...
          return res.status(200).json({
            success: true,
            data: milestones.success ? milestones.data : {},
          });
        }
        ...
        if (mode === "payouts") {
          ...
          return res
            .status(200)
            .json({ success: true, data: payouts.success ? payouts.data : {} });
        }
        ...
        if (mode === "growth") {
          ...
          return res
            .status(200)
            .json({ success: true, data: growth.success ? growth.data : {} });
        }
        ...
        if (mode === "engagement") {
          ...
          return res.status(200).json({
            success: true,
            data: engagement.success ? engagement.data : {},
          });
        }
        ...
        if (mode === "verification") {
          ...
          return res.status(200).json({
            success: true,
            data: verification.success ? verification.data : {},
          });
        }
        ...
        if (mode === "campaigns") {
          ...
          return res.status(200).json({
            success: true,
            data: campaigns.success ? campaigns.data : {},
          });
        }
        ...
        if (mode === "moderation") {
          ...
          return res.status(200).json({
            success: true,
            data: moderation.success ? moderation.data : {},
          });
        }

        if (mode === "all") {
          const [health, trust, escrow, milestones, payouts] =
            await Promise.all([
              calculatePlatformHealth(),
              calculateTrustDistribution(),
              getEscrowStats(),
        ...
        return res
          .status(500)
          .json({ error: "Failed to fetch platform analytics" });
      }
    }
