  ...
  async function handleLogin(e) {
    ...
    if (error) {
      ...
      const unverified =
        ...
        /not confirmed|email not verified|verify your email/i.test(error.message);
                  ...
                  {resendState === "resent" && (
                    ...
                    >
                      <div className="flex items-center gap-2 px-4 py-3 rounded-xl bg-success-muted border border-success/20">
                        <span className="material-symbols-outlined text-success text-[18px]" aria-hidden="true">mark_email_read</span>
          ...
          >
            {[
              ...
              <div key={item.label} className="flex items-center gap-2">
                ...
                <span className="font-geist text-[11px] font-medium text-on-surface-variant uppercase tracking-widest">{item.label}</span>
              </div>
            ))}
          </motion.div>
        </motion.div>
