...
const EarningsDashboard = dynamic(() => import("../../components/creator/EarningsDashboard"), {
  ssr: false,
  loading: () => (
    ...
    <div className="min-h-screen bg-black">
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-400 text-sm mt-1">View your earnings, escrow balances, and request payouts</p>
        </div>
        <EarningsDashboard />
      </div>
    </div>
