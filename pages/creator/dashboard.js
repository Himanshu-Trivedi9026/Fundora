...
export default function CreatorDashboard() {
  ...
  const fetchDashboard = useCallback(async () => {
    ...
    try {
      ...
      const totalRaised =
        projects?.reduce(
          (sum, p) => sum + (parseFloat(p.pledged) || 0),
          0
        ) || 0;
  ...
  const welcomeTips = data.projectCount === 0
    ? [
  ...
  const quickActions = [
    { label: "Create Campaign", href: "/create", icon: "add_circle", description: "Launch a new project" },
    { label: "Analytics", href: "/creator/analytics", icon: "analytics", description: "Track performance" },
    { label: "Milestones", href: "/creator/milestones", icon: "flag", description: "Manage milestones" },
    { label: "Verification", href: "/creator/verification", icon: "verified_user", description: "Verify your identity" },
  ];
    ...
    <PageLayout>
      <div className="min-h-screen bg-gradient-to-br from-[#0a0a0f] via-[#0d0d15] to-[#0a0a0f]">
        <div className="max-w-7xl mx-auto px-4 py-8 space-y-6">
          <VerificationGate>
          {/* Breadcrumbs */}
          <Breadcrumbs items={[{ label: "Creator", href: "/creator/dashboard" }, { label: "Dashboard" }]} />
          ...
          <div className="fade-in-up" style={{ animationDelay: "0.06s" }}>
            ...
            >
              ...
              {stats.map((stat, index) => (
                <div key={index} className="glass-card p-4 hover:border-primary/30 transition-all duration-200">
                  <div className="flex items-start justify-between mb-3">
                    <span className={`material-symbols-outlined text-[28px] ${stat.color}`} aria-hidden="true">
                      {stat.icon}
                    </span>
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2">
              <SectionCard
                ...
                viewAllLink={data.projectCount > 0 ? "/creator/projects" : undefined}
              >
                {data.latestProject && (
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-3 border-t border-white/[0.06]">
                    <div className="flex justify-between text-sm">
                      <span className="text-on-surface-variant">On Hold</span>
