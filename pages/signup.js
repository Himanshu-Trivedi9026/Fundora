...
/* ─── Input Component ─── */
const FormInput = forwardRef(function FormInput({ id, label, type, placeholder, value, onChange, icon: Icon, hint }, ref) {
    ...
    <div className="space-y-2">
      ...
      <div className="relative group">
        ...
        <input
          ...
          value={value}
          onChange={onChange}
          autoComplete={type === "password" ? "new-password" : type === "email" ? "email" : type === "text" && id === "signup-name" ? "name" : "off"}
      ...
      {hint && (
        <p className="text-[12px] text-on-surface-variant/70 px-1 font-inter">{hint}</p>
      )}
    </div>
  );
});
        ...
        >
          ...
          <motion.div variants={fadeUp} className="flex flex-col items-center mb-10 text-center">
            ...
            <p className="font-inter text-base text-on-surface-variant max-w-sm mx-auto leading-relaxed">
              Join the architectural intelligence revolution in decentralized finance.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="p-8 md:p-10 relative z-10">
              ...
              <div className="mb-6 flex items-center gap-2 px-4 py-3 rounded-xl bg-surface-container-high border border-outline-variant/30">
                <span className="material-symbols-outlined text-[18px] text-primary" aria-hidden="true">verified_user</span>
                <p className="font-inter text-sm text-on-surface-variant">
                  You&apos;re joining as{" "}
                  <span className="font-semibold text-on-surface">{roleLabel(signupRole)}</span>
                </p>
              </div>
                  ...
                  {success && (
                    ...
                    >
                      <div className="flex items-center gap-2 px-4 py-3 rounded-xl bg-success-muted border border-success/20">
                        ...
                        <p className="text-success text-sm font-inter">{success}</p>
                      </div>
                    </motion.div>
                  )}
                </AnimatePresence>
          ...
          >
            ...
            <div className="flex gap-5">
              <span className="font-geist text-[11px] font-semibold text-on-surface-variant/60 uppercase tracking-widest">Venture</span>
              <span className="font-geist text-[11px] font-semibold text-on-surface-variant/60 uppercase tracking-widest">Capital</span>
              <span className="font-geist text-[11px] font-semibold text-on-surface-variant/60 uppercase tracking-widest">Global</span>
            </div>
          </motion.div>
        </motion.div>
      </main>
