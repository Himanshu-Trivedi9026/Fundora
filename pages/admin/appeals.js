...
const AppealsDashboard = dynamic(() => import("../../components/admin/AppealsDashboard"), {
  ssr: false,
  loading: () => (
  ...
  return (
    <PageLayout>
      <Head>
        ...
        <meta name="description" content="Appeal management and review dashboard" />
      </Head>
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#0a0a0f] via-[#0d0d15] to-[#0a0a0f]">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-sm mt-1">Review and resolve user appeals with fair decisions</p>
          </div>
          <AppealsDashboard />
        </div>
      </div>
