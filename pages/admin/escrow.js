...
const EscrowDashboard = dynamic(() => import("../../components/admin/EscrowDashboard"), {
  ssr: false,
  loading: () => (
    <div className="min-h-screen bg-black flex items-center justify-center" role="status" aria-label="Loading escrow dashboard">
      ...
      <div className="min-h-screen bg-black">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-sm mt-1">Manage escrow accounts, releases, and payouts</p>
          </div>
          <EscrowDashboard />
        </div>
      </div>
