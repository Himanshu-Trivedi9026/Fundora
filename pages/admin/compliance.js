/**
 * Admin Compliance Page — Compliance Center for admins.
 *
...
const ComplianceDashboard = dynamic(() => import("../../components/admin/ComplianceDashboard"), {
  ssr: false,
  loading: () => (
...
export default function CompliancePage() {
  ...
  return (
    <PageLayout>
      <Head>
        <title>Compliance Center — Fundora Admin</title>
        <meta name="description" content="Compliance case management dashboard" />
      </Head>
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#0a0a0f] via-[#0d0d15] to-[#0a0a0f]">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-sm mt-1">Manage compliance cases, investigations, and escalations</p>
          </div>
          <ComplianceDashboard />
        </div>
      </div>
