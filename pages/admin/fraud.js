...
const FraudDashboard = dynamic(() => import("../../components/admin/FraudDashboard"), {
  ssr: false,
  loading: () => (
    <div className="flex items-center justify-center min-h-[400px]" role="status" aria-label="Loading fraud center">
  ...
  return (
    <PageLayout>
      <Head>
        ...
        <meta name="description" content="Fraud detection and risk management dashboard" />
      </Head>
      <main className="min-h-screen bg-gradient-to-br from-[#0a0a0f] via-[#0d0d15] to-[#0a0a0f] p-6 pt-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-sm mt-1">Fraud detection, risk analysis, and case management</p>
          </div>
          <FraudDashboard />
        </div>
      </main>
